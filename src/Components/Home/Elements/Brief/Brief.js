            ...
            <div className="list-group" style={{margin: "1%"}}>
                <a href="#" className="list-group-item list-group-item-action flex-column align-items-start">
                    ...
                    <p className="mb-1" style={{textAlign:"left"}}>
                        Hi, my name is Shiyu Jiang (江世宇), a postgraduate computer science student at Whiting School of
                        Engineering, Johns Hopkins University. In the past, I have working experience at the Chinese
                        Academy of Sciences advised by
