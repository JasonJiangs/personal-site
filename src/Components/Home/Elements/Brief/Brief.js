        ...
        <div>
            <div className="list-group">
                <a className="list-group-item list-group-item-action flex-column align-items-start">
                    ...
                    <p className="mb-1" style={{textAlign:"left"}}>
                        Currently, I am working as a research assistant at Dr.Ghobadi's Lab
                        ...
                        and working at <a href="https://zanglab.github.io/"> Chongzhi Zang Lab</a> at UVa School of Medicine in bioinformatics and computational biology.
                    </p>
                    <p className="mb-1" style={{textAlign:"left"}}>
                ...
                <a className="list-group-item list-group-item-action flex-column align-items-start">
                    ...
                    <p className="mb-1" style={{textAlign:"left"}}>
                        My research interests include bioinformatics, software engineering, and healthcare systems.
                        ...
                        which leads me get interested in Bioinformatics and comp bio.
                    </p>
                    <small className="text-muted"></small>
                </a>
                <a className="list-group-item list-group-item-action flex-column align-items-start">
                ...
                <a className="list-group-item list-group-item-action flex-column align-items-start">
                    ...
                    <p className="mb-1" style={{textAlign:"left"}}>
                        During my leisure time, I am a soccer fan and skillfull soccer player.
                        I was a soccer team captain of my high school and undergrad university.
